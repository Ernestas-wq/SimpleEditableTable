// Mygtukas naujam irasui
var naujas = document.getElementById("new");
// Sukuriu du modalus, placeholderiai inputui
var modal = document.getElementById("modal");
var modal2 = document.getElementById("modal2");
var modal3 = document.getElementById("modal3");
// realedit tai antro modalo redagavimo mygtukas, ji paspaudus turetu ivykti final edits
var realedit = document.getElementById("realedit");

// Fuflo uzdarymo mygtukai abiem modalam
var uzdaryti = document.getElementById("close");
var uzdaryti2 = document.getElementById("close2");
...
// priskiriu mygtukus atitinkamieim modalams, naujas - atidaro naujo iraso modala,
// ir abu uzdarymo mygtukai.
naujas.addEventListener("click", function (e) {
  modal.style.top = "3%";
});
uzdaryti.addEventListener("click", function (e) {
  modal.style.top = "-100%";
});
uzdaryti2.addEventListener("click", function (e) {
...
function fillTable() {
  ...
  if (data.length <= 0 || numeris <= 0 || kelias <= 0 || laikas <= 0) {
    ...
    var greitis = Math.round(
      (parseInt(someArr[2]) / parseInt(someArr[3])) * 3.6
    );
  ...
  mygt2.addEventListener("click", function () {
    ...
    function keisti() {
      ...
      // console.log(finalArr[4]);
      // console.log(newGreitis);
